...
Level (Warning is default):
DEBUG: Detailed information, for diagnosing problems. Value=10.
INFO: Confirm things are working as expected. Value=20.
WARNING: Something unexpected happened, or indicative of some problem. But the software 
is still working as expected. Value=30.
...
python.org -16.6.7. LogRecord attributes
'''
import logging
...
###
# # https://youtu.be/jxmzY9soFXg __name__
